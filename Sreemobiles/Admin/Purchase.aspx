...
<asp:GridView ID="gvProducts" runat="server"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Purchase">
            <ItemTemplate>
                <asp:TextBox ID="txtPurchase" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Retail">
            <ItemTemplate>
                <asp:TextBox ID="txtRetail" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Margin %">
            <ItemTemplate>
                <asp:TextBox ID="txtMargin" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="HSN">
            <ItemTemplate>
                <asp:TextBox ID="txtHSN" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>

        <asp:TemplateField HeaderText="CGST">
            <ItemTemplate>
                <asp:TextBox ID="txtCGST" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>

        <asp:TemplateField HeaderText="SGST">
            <ItemTemplate>
                <asp:TextBox ID="txtSGST" runat="server" CssClass="form-control" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
